...
public class UnlitCandleItem extends BlockItem {

    public UnlitCandleItem(RegistryObject<Block> block, Properties properties) {
    ...
    public BlockState getPlacementState(BlockPlaceContext context) {
        ...
        if (state != null) {
            ...
            if (state.getValue(net.minecraft.world.level.block.CandleBlock.CANDLES) == 1) {
                return state
                        .setValue(net.minecraft.world.level.block.CandleBlock.LIT, false)
                        .setValue(RealisticCandleBlock.getLitState(), RealisticCandleBlock.UNLIT)
