...
public class ModCreativeModeTabs {
    ...
    public static CreativeModeTab REALISTIC_TORCHES_EXTENDED_TAB;

    public static void register(IEventBus eventBus) {
        eventBus.addListener(ModCreativeModeTabs::registerCreativeTabs);
    }

    private static void registerCreativeTabs(CreativeModeTabEvent.Register event) {

        REALISTIC_TORCHES_EXTENDED_TAB = event.registerCreativeModeTab(
                new ResourceLocation(
                        RealisticTorchesExtended.MOD_ID,
                        "realistic_torches_extended_tab"
                ),
                builder -> builder
                        .title(Component.translatable(
                                "creativetab.realistic_torches_extended_tab"
                        ))
                        .icon(() -> new ItemStack(
