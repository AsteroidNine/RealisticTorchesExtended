...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> REALISTIC_CAMPFIRE = registerBlock("realistic_campfire", () -> new RealisticCampfireBlock(true, 1, AbstractBlock.Properties.copy(Blocks.CAMPFIRE), 14, 12), false);
    public static final RegistryObject<Block> REALISTIC_SOUL_CAMPFIRE = registerBlock("realistic_soul_campfire", () -> new RealisticCampfireBlock(true, 2, AbstractBlock.Properties.copy(Blocks.SOUL_CAMPFIRE), 10, 8), false);
    ...
    private static <T extends Block> RegistryObject<Item> registerBlockItem(String name, RegistryObject<T> block) {
        return ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().tab(ItemGroup.TAB_MISC)));
    }
